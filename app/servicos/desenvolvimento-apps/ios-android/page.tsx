...
const benefits = [
  ...
  "Presença nas lojas oficiais (App Store e Play Store)",
  "Maior engajamento dos usuários",
]

export default function IosAndroidPage() {
  return (
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Apps para <span className="text-kanoe-beige">iOS e Android</span>
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <SectionHeading
            ...
            subtitle="Desenvolvemos aplicativos nativos com todos os recursos necessários para uma experiência excepcional."
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Aplicativos nativos oferecem diversos benefícios para sua empresa:
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Entre em contato conosco hoje mesmo e descubra como podemos ajudar a transformar sua ideia em um aplicativo de sucesso.
            </p>
