        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Apps <span className="text-kanoe-beige">Corporativos</span>
            </h1>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <SectionHeading
            ...
            subtitle="Desenvolvemos aplicativos corporativos com todos os recursos necessários para otimizar seus processos."
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Um aplicativo corporativo bem desenvolvido traz diversos benefícios para sua empresa:
              </p>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Pronto para transformar seus processos?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Entre em contato conosco hoje mesmo e descubra como podemos ajudar a otimizar as operações da sua empresa com um aplicativo corporativo.
            </p>
