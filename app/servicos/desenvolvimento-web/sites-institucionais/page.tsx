...
const benefits = [
  ...
  "Aumento da credibilidade junto ao público",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Sites <span className="text-kanoe-beige">Institucionais</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl">
              Criação de sites profissionais que representam a identidade da sua marca e comunicam sua proposta de valor de forma eficaz.
            </p>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <SectionHeading
            ...
            subtitle="Desenvolvemos sites institucionais completos com todos os recursos necessários para o sucesso do seu negócio online."
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Um site institucional bem desenvolvido traz diversos benefícios para sua empresa:
              </p>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Pronto para criar seu site institucional?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Entre em contato conosco hoje mesmo e descubra como podemos ajudar a fortalecer sua presença online.
            </p>
