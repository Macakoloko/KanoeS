        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-kanoe-beige">E-commerce</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl">
              Desenvolvimento de lojas virtuais completas, seguras e otimizadas para conversão, com integração de pagamentos e gestão de estoque.
            </p>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <SectionHeading
            ...
            subtitle="Desenvolvemos plataformas de e-commerce completas com todos os recursos necessários para vender online."
          />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                Uma loja virtual bem desenvolvida traz diversos benefícios para seu negócio:
              </p>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Pronto para vender online?</h2>
            <p className="text-xl text-gray-300 mb-8">
              Entre em contato conosco hoje mesmo e descubra como podemos ajudar a expandir seu negócio para o mundo digital.
            </p>
